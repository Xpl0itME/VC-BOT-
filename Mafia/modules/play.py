...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/4c2afb1c9aba4a418acf3.jpg"
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ **Playing** here the song requested by {} via ꗄ➺ ᴍ𝐚я𝖎𝐚 ✘".format(
        ...
        [
            ...
            [
                InlineKeyboardButton(
                    text="Join Updates Channel", url=f"https://t.me/maria_support"
                )
            ],
            [InlineKeyboardButton(text="❌ Close", callback_data="cls")],
        ]
